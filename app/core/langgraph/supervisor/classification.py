"""The in-scope check used by the supervisor topic gate."""

from langchain_core.messages import HumanMessage

from app.core.langgraph.supervisor.prompts import load_topic_gate_prompt
...
async def llm_classify(conversation: str) -> IntentDecision:
    ...
    return await llm_service.call(
        [HumanMessage(content=load_topic_gate_prompt(conversation))],
