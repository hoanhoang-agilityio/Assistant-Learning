...
EXPECTED_EDGES = {
    ...
    (Node.PERSIST_PROFILE, None, Node.PERSIST_PREFERENCES),
    (Node.PERSIST_PREFERENCES, "coaching", Node.CHECK_PROFILE_COMPLETE),
    (Node.PERSIST_PREFERENCES, "qa", Node.QA_AGENT),
