...
from src.core.langgraph.prompts.coach_agent import COACH_AGENT_SYSTEM
...
from src.core.langgraph.prompts.turn_parser import TURN_PARSER_SYSTEM

SYSTEM_PROMPTS = (COACH_AGENT_SYSTEM, QA_AGENT_SYSTEM, TURN_PARSER_SYSTEM)
...
def test_every_prompt_carries_the_same_wording() -> None:
    ...
    assert security_block("<user_message>") in TURN_PARSER_SYSTEM
