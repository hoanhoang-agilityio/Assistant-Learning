...
from core.subgraphs.fitness.artifacts import write_fitness_artifacts
...
from core.subgraphs.fitness.context import load_fitness_context
from core.subgraphs.fitness.edit_ops import (
...
from core.subgraphs.fitness.macros import calculate_macros_data, compute_weekly_sets
...
from core.subgraphs.fitness.safety import _check_equipment_mismatch as _check_equipment_mismatch
from core.subgraphs.fitness.safety import (
    collect_unsafe_markup_feedback,
    contains_unsafe_markup,
    humanize_safety_feedback,
    validate_workout_safety_data,
)
from core.subgraphs.fitness.synthesis import build_workout_summary, synthesize_plan_data
