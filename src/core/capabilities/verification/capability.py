...
Domain decision logic lives in `core.capabilities.verification.executor`; this
...
from core.capabilities.verification.executor import get_verification_executor
