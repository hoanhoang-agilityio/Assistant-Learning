...
/**
 * The six-stage progress bar. Stages with data show a check. Every stage gets
 * an equal column, so the circles sit at even steps and the bar, inset by half
 * a column on each side, runs from the first circle's centre to the last's:
 * `progress` 20 reaches exactly the second circle.
 */
